...
part of 'transactions_details_api.dart';
...
class _TransactionsDetailsApi implements TransactionsDetailsApi {
  _TransactionsDetailsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CustomerDailyReportModel> update({
    ...
    final _data = updateTransactionDetailsReq;
