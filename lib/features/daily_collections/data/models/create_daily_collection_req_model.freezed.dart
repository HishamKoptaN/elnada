...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateDailyCollectionReqModel&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.amount, amount) || other.amount == amount));
}
...
@override
String toString() {
  return 'CreateDailyCollectionReqModel(customerId: $customerId, amount: $amount)';
}
...
class _CreateDailyCollectionReqModel implements CreateDailyCollectionReqModel {
  const _CreateDailyCollectionReqModel({@JsonKey(name: 'customer_id') required this.customerId, @JsonKey(name: 'amount') required this.amount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateDailyCollectionReqModel&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.amount, amount) || other.amount == amount));
}
