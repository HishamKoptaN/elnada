...
part of 'daily_collections_api.dart';
...
class _DailyCollectionsApi implements DailyCollectionsApi {
  _DailyCollectionsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CustomerDailyReportModel> create({
    ...
    final _data = createDailyCollectionReqModel;
  ...
  Future<CustomerDailyReportModel> update({
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = updateDailyCollectionReqModel;
    final _options = _setStreamType<CustomerDailyReportModel>(
