...
class _CustomersApi implements CustomersApi {
  _CustomersApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CustomerDailyReportsResModel> getCustomers({
    ...
    final queryParameters = <String, dynamic>{r'date': date, r'query': query};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CustomerDailyReportsResModel>(
    ...
    late CustomerDailyReportsResModel _value;
    try {
      _value = CustomerDailyReportsResModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CustomerDailyReportModel> create({
    required CreateCustomerModel createCustomer,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = createCustomer;
